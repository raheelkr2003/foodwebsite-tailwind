  ...
  return (
    <nav className='flex justify-between px-5 p-2 sm:flex-row flex-col'>
        <div className='flex justify-center items-center'>
            <img className='w-[60px]' src="https://media.istockphoto.com/id/1443607181/photo/capital-letter-with-serif-on-wood-smeared-with-paint-on-white-background-alphabet-w.jpg?s=1024x1024&w=is&k=20&c=KGw78_jZzIqJn0PHmlJpXeTWjv1dPDmkTHR96xtjDgI=" alt="" />
